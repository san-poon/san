  ...
  return (
    <>
      ...
      <section className="mt-12">
        <Card className="relative overflow-hidden px-6 sm:px-8">
          ...
          <ul className="grid gap-4 sm:grid-cols-2">
            {posts.map(({ slug, en }) => (
              <li key={slug}>
                <Card className="group p-4 transition-colors hover:shadow-sm">
      ...
      <section id="projects" className="mt-12">
        ...
        <Card className="relative overflow-hidden px-6 sm:px-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Card className="group p-5 backdrop-blur-sm transition-shadow hover:shadow-sm">
